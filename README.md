...
- Plein écran mobile : tentative automatique au premier toucher d’un contrôle de navigation, lorsque l’API est disponible. Réglages pour sortir/réactiver ; aucune réactivation forcée après une sortie. L’autorisation gestuelle du navigateur ne peut pas être contournée. Selon le navigateur, Retour peut d’abord quitter le plein écran avant de parcourir l’historique.
